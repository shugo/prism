...
# src/parsey/parse.c is generated by lrama (`rake parsey:generate`) and checked
# in; VPATH exposes the grammar next to it, so cancel make's builtin yacc rules
# or a fresh checkout's arbitrary mtimes can send the grammar to bison.
